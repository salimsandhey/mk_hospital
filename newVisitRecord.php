...
$visits_sql = "SELECT id, visit_date, treatment FROM visits WHERE patient_id = '$patient_id' ORDER BY visit_date DESC";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="sidebar">
            ...
            <a href="new_visit.php?id=<?php echo $patient_id; ?>">New Visit</a>
            <a href="visit_history.php?id=<?php echo $patient_id; ?>">Visit History</a>
            ...
            <?php else: ?>
                <p class="text-center">No previous visits found.</p>
            <?php endif; ?>
        </div>
        ...
        <div class="content">
            ...
            <form action="saveVisit.php" method="POST" enctype="multipart/form-data">
                ...
                <div id="xray_details_container" style="display: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="xray_file[]" id="xray_file" accept="image/*"
                            multiple>
            ...
            <div class="container">
                <h2>New Visit</h2>
                <!-- New visit form goes here -->

                <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#previousVisits"
                    aria-expanded="false" aria-controls="previousVisits">
                    View Previous Visits
                </button>

                <div class="collapse" id="previousVisits">
                    <div class="card card-body">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<li>Date: " . $row['visit_date'] . ", Treatment: " . $row['treatment'] . ", Medicines: " . $row['medicines'] . "</li>";
                            }
                            echo "</ul>";
                        } else {
